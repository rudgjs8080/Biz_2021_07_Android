...
public class MainActivity extends AppCompatActivity {
   ...
   private RecyclerView recyclerView;
     ...
     *
     * App을 실행했을 때
     * Android 가 폰에서 어플을 읽어서 메모리에 load하고
    ...
    // App 이 실행될 때 가장 먼저 호출되어 코드가 실행되는 method
     ...
     *
     * 이 method는 Android가 App을 화면에 띄울 때 자동으로
     * 호출하여 사용하는 method
     *
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        /**
         * 검색창에 값이 입력되고, 키보드의 검색을 클릭 했을 때
         * 반응할 event 설정하기
         */
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {

            // 검색창에 문자열을 입력하고
            // 키보드의 검색 버튼을 클릭했을 때 반응
            @Override
