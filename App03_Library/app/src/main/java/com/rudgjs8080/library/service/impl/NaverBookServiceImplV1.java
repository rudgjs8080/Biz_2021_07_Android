package com.rudgjs8080.library.service.impl;
...
import com.rudgjs8080.library.adapter.BookViewAdapter;
import com.rudgjs8080.library.config.NaverAPI;
import com.rudgjs8080.library.model.NaverBookDTO;
import com.rudgjs8080.library.model.NaverParent;
import com.rudgjs8080.library.service.NaverBookService;
import com.rudgjs8080.library.service.NaverRetrofit;
import com.rudgjs8080.library.service.RetrofitAPIClient;
...
public class NaverBookServiceImplV1 implements NaverBookService {
    ...
    public NaverBookDTO getBooks(String search){
         ...
         * Retrofit이 응답을 받아서 처리할 event(call back)을 설정해줘야 한다
         *
         * Call Back Event 핸들링 코드
         * CallBack interface 를 익명 클래스로 선언하는 코드
         *      Skeletone Code 라고도 한다
         *
         *
         */
        retrofitReturn.enqueue(new Callback<NaverParent>() {
            ...
            public void onResponse(Call<NaverParent> call, Response<NaverParent> response) {
                ...
                if(resCode < 300){
                    ...
                    Log.d("오류 발생", response.body().toString());
                }
            }
