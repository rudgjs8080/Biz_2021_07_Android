package com.rudgjs8080.library.adapter;
...
import com.rudgjs8080.library.R;
...
public class BookViewAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
         ...
         * 객체로 생성하는 것
         */
        // item.xml 파일을 읽어와서 Holder로 만들기 전에 확장하기 위한 도구
     ...
     * 몇 번째 데이터를 Binding 할 것인지에 대한 index로 position 변수에
     * 값을 전달해 준다
     */
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
         ...
         * 직접 이미지를 다운로드 하거나 하면 무넺를 일으킬 수 있다
         *
         * 안들외드에서 이미지 링크를 실제 이미지로 보여주는데
         * Picasso, Glide와 같은 3d party 라이브러리를 사용하여
         * 화면에 이미지를 구현한다
         *
         *          picasso         Glide
         * 속도     다소 느림        다소 빠름
     ...
     * RecyclerView에게 지금 데이터가 몇 개 인지 알려주고
     ...
     * 생성하기 위한 보조 class
     *
     * 초기의 RecyclerView인 ListView 시절에는
     * 선택 사항으로 만들지 않아도 됐었지만
