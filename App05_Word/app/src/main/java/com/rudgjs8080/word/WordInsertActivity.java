...
import com.rudgjs8080.word.databinding.WordInsertActivityBinding;

public class WordInsertActivity extends AppCompatActivity {

    WordInsertActivityBinding wordBinding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        wordBinding = WordInsertActivityBinding.inflate(getLayoutInflater());

        // Binding을 적용하여 Activity 화면 그리기
        // setContentView(R.layout.word_insert_activity);
