package com.rudgjs8080.word.config;
 ...
 * 여기서는 table에 변경이 이뤄지면 WordDTO 클래스에 칼럼들을
 * 변경하는 작업을 수행한다
 * 그리고, version number를 현재 값보다 큰 값으로 변경한다
...
public abstract class WordDataBase extends RoomDatabase {
    ...
    // 데이터 관련 코드에서 상요할 DB Connection(Session) 객체를
    // return 하는 method
