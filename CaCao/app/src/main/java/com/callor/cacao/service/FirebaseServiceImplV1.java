 ...
 * 그 신호를 event로 받아서 처리하는 클래스를 작성하기 위한 interface
 */
public class FirebaseServiceImplV1 implements ChildEventListener{

    /**
     * ChattAdapter 객체가 하는 일
     * RecyclerView와 연동하여 데이터를 화면에 그리기 위한 중간 연결 도구
     *
     * Adapter를 MainActivity로 부터 전달받아서 firebase database에 데이터가 추가되면
