package com.rudgjs8080.topnews.adapter;
...
import com.rudgjs8080.topnews.databinding.NewsItemViewBinding;
...
public class NewsViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        /**
         * 매개변수로 받은 holder는
         * RecyclerView.ViewHolder type으로 실제 사용해야 하는
         * NewsViewHolder 부모 클래스 type이다
    ...
    public static class NewsViewHolder extends RecyclerView.ViewHolder {
        ...
        /**
         * binding 속성을 사용하면
         * item_view.xml 설정된 view component를 일일이 찾아서
         * 초기화 하는 코드가 필요 없어진다
         * item_view.xml 파일에 의해 생성된
         * ItemViewBinding 클래스를 사용하여 모든 view component를
         * 한꺼번에 ViewHolder로 생성할 수 있다
         */
